...
def main(args: Namespace) -> None:
    ...
    # minimization_parameters.pop("enues.sin_sq_weinberg", None)
...
# if args.output_sin_sq_weinberg:
#         removed_sin_sq_weinberg = minimization_parameters.pop("enues.sin_sq_weinberg", None)
#         sin_sq_w_values = np.linspace(0.2, 0.25, 101)
#         chi2_values = []
...
#     outputs.add_argument(
#         "--output-sin_sq_weinberg",
#         action="store_true",
#         help="Output chi2_sin_sq_w",
#     )